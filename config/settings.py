...
MIDDLEWARE = [
    ...
    'accounts.middleware.SystemAdministrationBoundaryMiddleware',
    'accounts.middleware.UserPreferredLanguageMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.administration_dashboard',
            ],
        },
    },
]
